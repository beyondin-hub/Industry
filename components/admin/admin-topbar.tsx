      ...
      <div className="ml-auto flex items-center gap-3">
        <div className="flex items-center gap-2.5">
          <div className="hidden text-right sm:block">
            <p className="text-sm font-semibold leading-tight text-ink-900">Equipo Novak</p>
            <p className="flex items-center justify-end gap-1 text-xs text-ink-500"><Shield className="size-3 text-safety" /> Operaciones</p>
          </div>
          <div className="flex size-9 items-center justify-center rounded-full bg-ink-950 text-sm font-bold text-white">NV</div>
        </div>
